package com.angesh.cvbuilderapplicationassignment6.ui.contact
...
import com.angesh.cvbuilderapplicationassignment6.MyWebActivity
...
class ContactFragment : Fragment(R.layout.fragment_contact), OnClickListener {
    ...
    private fun onMobileClicked() {
        val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "+16418191623"))
